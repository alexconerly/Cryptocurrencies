...
For organizational purposes, a new dataframe visualization was created without the vestigial three principal component columns by using hvplot (see below). 
